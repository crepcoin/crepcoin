...
namespace CryptoNote {
	...
	bool Currency::getBlockReward(uint8_t blockMajorVersion, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins,
		...
		if(alreadyGeneratedCoins < CryptoNote::parameters::BLOCK_REWARD_BONUS_V1)
		{
			baseReward = baseReward + CryptoNote::parameters::REWARD_BONUS_V1;
		}
		else if(alreadyGeneratedCoins < CryptoNote::parameters::BLOCK_REWARD_BONUS_V2)
		{
			baseReward = baseReward + CryptoNote::parameters::REWARD_BONUS_V2;
		}
		else if(alreadyGeneratedCoins < CryptoNote::parameters::BLOCK_REWARD_BONUS_V3)
		{
			baseReward = baseReward + CryptoNote::parameters::REWARD_BONUS_V3;
		}
		else if(alreadyGeneratedCoins < CryptoNote::parameters::BLOCK_REWARD_BONUS_V4)
		{
			baseReward = baseReward + CryptoNote::parameters::REWARD_BONUS_V4;
		}
		else if(alreadyGeneratedCoins < CryptoNote::parameters::BLOCK_REWARD_BONUS_V5)
		{
			baseReward = baseReward + CryptoNote::parameters::REWARD_BONUS_V5;
		}
